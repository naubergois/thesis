...
Stress testing is boundary
testing. Some of the resources that stress testing
subjects to heavy loads include \cite{Lewis2005}:
...
The goal of the load design phase is to devise a load, which can uncover problems. Based on the objectives, there are two general schools of thought for designing a proper load to achieve such objectives \cite{Afzal2009a}:

\begin{itemize}
\item Designing Realistic Loads. 
\item Designing Fault-Inducing Loads.
\end{itemize}
...
\section{Automated Stress Test Tools}
