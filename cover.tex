...
\department{Doutorado em Informatica Aplicada}

% If the thesis is for two degrees simultaneously, list them both
% separated by \and like this:
% \degree{Doctor of Philosophy \and Master of Science}
\degree{Doctor of Science in Applied Informatics}
...
% once for each.
\supervisor{Pedro Porfirio Muniz de Farias}{Associate Professor}
