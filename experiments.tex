...
-20*maxResponseTime-penalty\} , \textsf{where n is the }\\\ \textsf{ number of scenarios used by the test in a set of previous selected scenarios}
\end{cases}
\end{aligned}
\end{equation}

\section{JPetStore experiment }
